      ...
      <div class="flex items-center">
        ...
        <div class="pl-3">
          <div class="flex items-center text-sm leading-none">
            <p class="font-semibold text-gray-800">Apple MacBook Pro 2020</p>
            <p class="text-indigo-700 ml-3">(ID 879-10-940)</p>
          </div>
          <p
            class="text-xs md:text-sm leading-none text-gray-600 mt-2"
          >15’5. Core i5. FHD. Integrated graphics</p>
        </div>
      </div>
    </td>
    <td class="pl-16">
      <div>
        <div class="flex items-center justify-center px-2 py-1 bg-green-100 rounded-full">
          <p class="text-xs leading-3 text-green-700">Validé</p>
        </div>
      </div>
    </td>
  </tr>
